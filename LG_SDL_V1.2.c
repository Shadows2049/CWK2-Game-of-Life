...
int done;
int quit_all;
int cell[Height+2][Width+2]; //1 for life, 0 for death
int pau;
...
int main(int argc, char *argv[])    //test main function
{
    ...
    window = SDL_CreateWindow("Chess Board", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1280, 720, SDL_WINDOW_RESIZABLE);
    if(!window)
    {
