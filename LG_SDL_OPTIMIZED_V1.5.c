...
{   int step=0;
    ...
    if(step_choice==2)
    {
        ...
        if(step<1)
        {
            printf("\nInvalid count,switch to unlimited steps\n");
            step_choice=1;
        }
    }
    ...
    printf("\npress 1 to quit program, click LEFT mouse to continue\n");
    ...
    window = SDL_CreateWindow("Chess Board", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1200, 1200, SDL_WINDOW_RESIZABLE);
